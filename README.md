...
> **정부지원사업 신청서 작성 자동화 웹 애플리케이션**
> 공고 검색, AI 분석, 사업계획서 초안 작성, 평가, Export를 한 화면에서 이어서 작업합니다.
...
**AJIN BizAI**는 이 과정의 반복 작업을 자동화합니다. 공고를 한곳에서 검색하고, 공고문과 제출양식을 AI가 구조화한 뒤, 회사 자료를 근거로 문항별 초안을 만들고 평가까지 이어서 진행합니다.
...
왼쪽 추출 항목 트리(섹션·문항·표), 가운데 작성 영역(AI 초안 생성·재생성·승인), 오른쪽 보완자료/AI 챗봇으로 구성된 3-pane 화면입니다. 문항별로 회사 자료 근거를 매핑해 초안을 만들고 inline 편집할 수 있습니다.
...
OLE 컨테이너 파싱, zlib 압축 해제, UTF-16LE 레코드 추출 과정을 구현했습니다.
